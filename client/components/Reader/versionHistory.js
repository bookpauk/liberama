...
`
<ul>
    <li>адаптирована работа приложения на iOS и macOS (браузер Safari) (#52)</li>
    <li>в конфиг добавлен параметр root, необходимый при настройке reverse-proxy (#53), теперь читалку можно встроить в любой сайт по отдельному пути
    </li>
